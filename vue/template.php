...
<head>
  ...
  <meta name="description"
    content="A l'ardoise vous propose midi et soir une proposition Entrée/Plat/Dessert de recettes. Vous pouvez également rechercher des plats dans notre base de données de recettes ou rechercher des recettes en fonction des ingrédients dans votre frigo.">
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="row logo w-100">
        <!-- Navbar brand -->
        <a class="navbar-brand mt-5 ml-5" href="index.php">
          <h1><?php echo $logo; ?></h1>
        </a>
      </div>
        ...
        <div class="collapse navbar-collapse menu w-100 " id="basicExampleNav">
          ...
          <form method="GET" class="form-inline">
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Rechercher une recette" name="text"
                aria-label="Recipient's username" aria-describedby="button-addon2">
              <div class="input-group-append">
                <button class="btn btn-light" type="submit" name="action" value="rechercher"
                  id="button-addon2">valider</button>
              </div>
            </div>
          </form>
        </div>
